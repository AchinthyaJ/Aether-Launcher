...
* **Instantaneous Launching**: Minecraft and client profiles spin up in milliseconds. No background telemetry bottlenecks, no forced news feeds.
* **The Fastest Server Launching Ever**: Instantly configure, host, and invite friends to your worlds. No network configuring, no router hassle, no waiting. Click, connect, play.
...
## ✨ Massive New Features Added in v2

### 🎨 Fully Customizable Instance Covers
...
Onboarding is now faster and more customizable than ever:
* **Segmented Authentication Controls**: Instantly toggle between secure **Microsoft OAuth** and **Offline Auth** in a single click.
* **Stunning Frameless Chrome**: A completely custom-drawn, draggable boarding window with glassmorphism panels, glowing nebula effects, and premium button animations.

### 👤 Integrated Skin & Cape Engine
Show off your visual style effortlessly:
* **Native Skin Management**: Upload, preview, and apply custom skins within the launcher.
* **Custom Node Skin Servers**: Full support for skin server API backends to display skins and capes in-game.

---

## 🔮 Coming in the v2 Lifecycle (v2.x)

We are just getting started. The following game-changing features are actively in development and will arrive during the **v2 lifecycle**:

* **🔌 Mods & Plugins for Tunneling Servers**: An automated installer and conflict scanner specifically tailored for hosted servers, letting you run paper/spigot/forge server setups with custom plugins in seconds.
* **🖼️ Advanced Layout Customization**: High-end drag-and-drop structural editor, customizable widgets, and a layout exchange marketplace.
* **📦 Global Server Templates**: Instant world-sharing capabilities to let friends download your modded servers and join with matching profiles in one click.
